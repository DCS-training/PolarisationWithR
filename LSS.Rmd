...
```{r}
data <- read_csv("EU-China_resolutions.csv")  # Load dataset
...
dfm_all <- dfm(tokens_all)  # Create document-feature matrix (DFM)
...
print(top_positive$full_text)  # Most positively scored documents

print(top_negative$full_text) # Most negatively scored documents
```
